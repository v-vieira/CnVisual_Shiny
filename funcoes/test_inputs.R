test_inputs <- function(input_metodo, input) {
  ...
  # Numericas
  type_num <- c("input_x0", "input_decimais", "input_iteracoes",
                "input_veloc_anim", "input_ponto_aprox", "input_ponto_input",
                "input_divisoes", "g_offset")
  # Lista de pontos str
  ...
  for (the_input in to_test) {
    ...
    # Teste da função
      ...
      if (str_detect(str_replace(met, c("sin", "sinpi", "sinh", "asinh",
                                        "factorial", "sign", "ceiling",
